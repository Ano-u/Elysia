        ...
        return (
          ...
          >
            ...
            >
              ...
              <div className={clsx("absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-[100%] pointer-events-none blur-md transition-all duration-300 w-6 h-18 bg-black/40")}/>
              <span
